...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegisteredUser.full_name'
        db.add_column(u'go_registereduser', 'full_name',
                      self.gf('django.db.models.fields.CharField')(default='CHANGEME', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegisteredUser.full_name'
        db.delete_column(u'go_registereduser', 'full_name')
