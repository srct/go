...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegisteredUser.description'
        db.add_column(u'go_registereduser', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegisteredUser.description'
        db.delete_column(u'go_registereduser', 'description')
